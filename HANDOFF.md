...
## 2026-09-19 (최신 47): **통증 진료 모델을 Task–Load–Capacity로 전환 (PO 승인)** + 임상지식베이스 `09_치료술기` 신설 + 매선 정본 5→3 병합. **저장소 코드 변경 0건**
...
3. **저장소 PR은 4건으로 늘었고 아직 시작 안 함.** DR_07을 반영해 계획을 수정했다(PO 승인). 상세는 `DECISIONS.md` 2026-09-19(저녁) 항목.
   ...
   - **PR 4 신설 — 0단계 정의 교정** — `LBP_STAGE_0_GUIDANCE_KO`의 "능동 운동을 처방하지 않습니다"를 "**구조화된 고부하 운동을 유예**하고 일상활동은 유지"로. `docs/LBP_EXERCISE_STAGE_ASSIGNMENT_v0.4.md` 개정이 **선행**.
