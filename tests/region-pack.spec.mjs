...
assert('C: detailCheckQuestionIdsForRegion(lbp) = common + LBP 3', same(detailCheckQuestionIdsForRegion('lbp'), [...DETAIL_CHECK_COMMON_QUESTION_IDS, 'LBP_12', 'LBP_13', 'LBP_14']))
