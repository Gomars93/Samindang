...
| 값이 도달해야 하는 곳 | 통증 | mixed | **한약 단독** | 재진 화면 | fixture |
|---|---|---|---|---|---|
| 원장 입력 화면 | 마무리 | 마무리(HerbalWorkspaceNext) | **판단·처치(신규)** | 있음 | 〃 |
| 0~10 버튼(NRS) | ✅ | ✅ | **✅ (같은 집합 전달)** | ✅(F2) | 〃 |
| EMR 텍스트 `재평가 대상` | ✅ | ✅ slim=false | **✅ slim에도 넘김(신규)** | 해당 없음 | 〃 |
| 환자 재진 링크 문항 | ✅ | ✅ | **✅ (지난 방문 타깃에서 후보 생성)** | ✅ | 해당 없음 |
| 「지난번 추적」 줄 | ✅ | ✅ | **✅ (프로필 무관 union)** | 해당 없음 | 〃 |
