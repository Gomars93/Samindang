...
export const HIP_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      { value: 'NONE', label: '해당 없음' }, { value: 'GROSS_DEFORMITY_OR_JOINT_STUCK_OUT_OF_POSITION', label: '관절 모양이 심하게 변했거나 제자리로 돌아오지 않은 느낌' },
  ...
  },
  {
    ...
    exclusive: ['NONE', 'UNKNOWN'],
    options: [
      { value: 'NONE', label: '해당 없음' }, { value: 'ATRAUMATIC_OR_INSIDIOUS_DEEP_HIP_OR_GROIN_PAIN', label: '뚜렷한 사고 없이 서서히 시작된 깊은 고관절·사타구니 통증' },
