...
| 4 | 단계표(§5) — 운동당 1/2/3/ALL | 요통 방식(0단계 = 고부하 운동 유예) | ☐ |
...
|---|---|---|
| 0 보호/안정 | 고부하 운동 유예(일상활동 유지·안전 재평가·통증 조절) | — (표에 넣지 않음) |
...
> **2026-09-07 갱신**: freeze(CLOSED v1.0)는 이 5건을 **B수준으로 재검증 완료**한 상태에서 이뤄졌다
> (`docs/REHAB_REFERENCE_VERIFICATION_LOG_v0.1.md` §2). 원문(A수준) 대조는 요통 팩과 같은 기준으로 **파일럿 전제조건이 아니라
> v1.1 항목**이다(`DECISIONS.md` 2026-09-07 "검증 수준 정책", `docs/NECK_PILOT_OBSERVATION_LOG_v1.0.md` §4-2). 아래 "필수"는 초안
> 당시의 표현으로 남긴다.
